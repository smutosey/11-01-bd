...
> #### Ответ:
> 
> Для данных по лидам с лендинга (т.е. та часть аудитории, которая заинтересовалась предложением на странице и захотела подробностей), можно использовать NoSQL СУБД ключ-значение (Redis), либо документно-ориентированной (MongoDB). Эти СУБД отлично справятся хранением объектов 
